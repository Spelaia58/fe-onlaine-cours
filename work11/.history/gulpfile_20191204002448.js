...
const watcher = done => {
  ...
  watch(paths.watch.css).on('change', series(tasks.css, browserSync.reload));watch(paths.watch.css).on(‘change’, function(){setTimeout( series(tasks.css, browserSync.reload) 100)});
